...
public class ClueUtils {
  ...
  public static String getNormalValue(String fieldName, String srcValue) {
        if(fieldName ==null || fieldName.isEmpty())
            return srcValue;
        String normalValue=srcValue;
        ...
        if(field != null){
            ...
            if(normal != null && normal.equals("yes")){
                if(normalType!=null){
                    switch (normalType){
                        case "mobile":
                            normalValue = DuUtils.duMobile(srcValue);
                            break;
                        case "idcard":
                            normalValue = DuUtils.duCard(srcValue);
                            break;
                        case "mac":
                            normalValue = DuUtils.duMac(srcValue);
                            break;
                        case "url":
                            normalValue = DuUtils.duUrl(srcValue);
                            break;
                        case "general":
                            normalValue = DuUtils.duNormal(srcValue);
                            break;
                        default:
                            normalValue = srcValue;
                            break;
                    }
                }
            }
   ...
   public  List<String> getConditions(Element element,List<String> list){
       ...
       if (null != element){
           ...
           if( op != null && op.equals("btw")){
               ...
               String fieldName = element.getText().trim();
               list.add(fieldName + "=" + getNormalValue(fieldName,value));
           }
       }
       return list;
    }
